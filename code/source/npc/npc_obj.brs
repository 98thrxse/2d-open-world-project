function npc_obj(object)
    ...
    ' addAnimatedImage
      ...
      m.addColliderRectangle("npc_col_up", m.obj.offset_x + 3, m.obj.offset_y + stand_side_region.GetHeight() / 2, stand_side_region.GetWidth() - 6, 1)
      m.addColliderRectangle("npc_col_down", m.obj.offset_x + 3, m.obj.offset_y + stand_side_region.GetHeight(), stand_side_region.GetWidth() - 6, 1)
      m.addColliderRectangle("npc_col_left", m.obj.offset_x, m.obj.offset_y + stand_side_region.GetHeight() / 2 + 3, 1, stand_side_region.GetHeight() / 2 - 6)
      m.addColliderRectangle("npc_col_right", m.obj.offset_x + stand_side_region.GetWidth(), m.obj.offset_y + stand_side_region.GetHeight() / 2 + 3, 1, stand_side_region.GetHeight() / 2 - 6)
