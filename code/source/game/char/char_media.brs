function char_media(object)
  ...
  object.onCreate = function(args)
    ...
    m.game.loadBitmap("attack_fist3", "pkg:/media/char/sprites/attack_fist3.png")
    m.game.loadBitmap("attack_fist4", "pkg:/media/char/sprites/attack_fist4.png")
    m.game.loadBitmap("attack_fist5", "pkg:/media/char/sprites/attack_fist5.png")
    m.game.loadBitmap("attack_fist6", "pkg:/media/char/sprites/attack_fist6.png")

    m.game.loadBitmap("attack_leg1", "pkg:/media/char/sprites/attack_leg1.png")
    m.game.loadBitmap("attack_leg2", "pkg:/media/char/sprites/attack_leg2.png")
    m.game.loadBitmap("attack_leg3", "pkg:/media/char/sprites/attack_leg3.png")
