function npc_control(object)
  ...
  object.onButton = function(code as integer)
    ...
    if code = 1002 ' up
      ...
      if m.game.char.getUpCol() = false and m.game.data.getFocusGroup() = "char"
      ...
      if m.game.char.getDownCol() = false and m.game.data.getFocusGroup() = "char"
      ...
      if m.game.char.getLeftCol() = false and m.game.data.getFocusGroup() = "char"
      ...
      if m.game.char.getRightCol() = false and m.game.data.getFocusGroup() = "char"
